...
<body>
            ...
            <div class="search-box">
                ...
                <?php if ($vista_inactivos): ?>
                    <div class="vista-info">
                        <strong>⚠️ Vista de proveedores inactivos</strong>
                        <p class="mb-0"><small>Estás viendo los proveedores que han sido dados de baja.</small></p>
                    </div>
                <?php endif; ?>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <button class='btn btn-editar me-2' data-bs-toggle='modal' data-bs-target='#editarProveedorModal' 
                                              ...
                                              data-direccion='<?= htmlspecialchars($proveedor["direccion"] ?? '') ?>'>✏️ Editar</button>
                                            <button class='btn btn-eliminar' data-bs-toggle='modal' data-bs-target='#eliminarProveedorModal' 
                                              data-id='<?= $proveedor["id_proveedor"] ?? '' ?>'
                                              data-nombre='<?= htmlspecialchars($proveedor["nombre"] ?? '') ?>'>🗑️ Eliminar</button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
    ...
    <div class="modal fade" id="eliminarProveedorModal" tabindex="-1" aria-labelledby="eliminarProveedorModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="eliminarProveedorModalLabel">🗑️ Eliminar Proveedor</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>¿Estás seguro de que deseas eliminar al proveedor <strong id="proveedor_eliminar" class="text-warning"></strong>?</p>
                    <p class="text-muted"><small>Esta acción marcará al proveedor como inactivo.</small></p>
    ...
    <div class="modal fade" id="editarProveedorModal" tabindex="-1" aria-labelledby="editarProveedorModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editarProveedorModalLabel">✏️ Editar Proveedor</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
